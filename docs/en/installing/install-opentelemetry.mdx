...
1. Check available versions
    ...
    **Example output**
    ...
    stable   opentelemetry-operator2.v0.157.0-rc.2     0.157.0-rc.2
    ```
...
4. Create a Subscription
    ...
    spec:
      ...
      startingCSV: opentelemetry-operator2.v0.157.0-rc.2
    EOF
    ```
...
6. Approve InstallPlan
    ...
    **Example output**
    ...
    install-abc12   opentelemetry-operator2.v0.157.0-rc.2     Manual     false
    ```
...
opentelemetry-operator2.v0.157.0-rc.2     Alauda Build of OpenTelemetry v2         0.157.0-rc.2              Succeeded
```
