...
When you no longer need the Operator to create cluster-level RBAC resources automatically, remove the `ClusterRole` and `ClusterRoleBinding` created in the [Procedure](#procedure) section to release the granted permissions.
