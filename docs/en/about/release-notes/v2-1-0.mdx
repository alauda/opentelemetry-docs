...
### Component type names now use snake_case \{#snake-case-names}
...
| OTLP gRPC exporter | `otlp` | `otlp_grpc` |
...
:::note The two OTLP exporters are renamed, the OTLP receiver is not
