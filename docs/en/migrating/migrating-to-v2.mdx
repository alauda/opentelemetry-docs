...
This document describes how to migrate an existing `Alauda Build of OpenTelemetry` (built on upstream OpenTelemetry Operator/Collector `0.108.0`) deployment to `Alauda Build of OpenTelemetry v2` (built on upstream Operator `0.157.0` and Collector `0.158.0`).
...
| Item | v1 | v2 |
| :--- | :--- | :--- |
| Upstream OpenTelemetry Operator version | 0.108.0 | 0.157.0 |
