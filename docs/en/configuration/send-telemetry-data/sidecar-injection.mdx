...
1. Deploy the OpenTelemetry Collector as a sidecar by running the following command:
   ...
   <Callouts>
    ...
    3. Replace `jaeger-<example>-collector` with the actual service name of your Alauda Build of Jaeger v2 collector. The format is typically `<instance-name>-collector`.
   </Callouts>
