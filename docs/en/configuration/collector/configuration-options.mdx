...
| `processors` | Defines data transformation operations applied between receiving and exporting. Processors are optional. | batch, memory_limiter, resource_detection, attributes, span, k8s_attributes, filter | None |
...
spec:
  ...
  hostAliases: # [!code callout]
    - ip: "10.0.0.10"
      hostnames:
        - "backend.internal"
  sessionAffinity: ClientIP # [!code callout]
