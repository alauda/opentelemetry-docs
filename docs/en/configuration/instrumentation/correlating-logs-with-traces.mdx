...
Detailed in-product guidance is provided for Java only. Log-to-trace correlation for other languages is handled by each language's OpenTelemetry SDK and instrumentation, and the field names and mechanisms differ per language. Refer to the upstream OpenTelemetry documentation for the language you use:

| Language | Reference |
| --- | --- |
| Python | [OpenTelemetry Python](https://opentelemetry.io/docs/languages/python/) |
| Node.js | [OpenTelemetry JavaScript](https://opentelemetry.io/docs/languages/js/) |
| Go | [OpenTelemetry Go](https://opentelemetry.io/docs/languages/go/) |
| .NET | [OpenTelemetry .NET](https://opentelemetry.io/docs/languages/net/) |
