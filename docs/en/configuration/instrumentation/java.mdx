...
3. Enables Java auto-instrumentation injection for this pod. See [Supported Values for Injection Annotations](./instrumentation-options.mdx#supported-injection-values) for the accepted values.
</Callouts>
