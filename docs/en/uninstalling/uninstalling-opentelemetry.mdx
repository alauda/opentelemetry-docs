...
## Uninstalling via the web console \{#uninstalling-via-the-web-console}
...
## Uninstalling via the CLI \{#uninstalling-via-the-cli}
...
1.  Get the `OpenTelemetryCollector` resources by executing this command:
    ...
    **Example output**
    ...
    <namespace>    <name>   deployment   0.158.0   1/1     3h38m   <image>   managed
    ```
