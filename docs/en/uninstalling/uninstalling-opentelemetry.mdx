...
1.  Get the `OpenTelemetryCollector` resources by executing this command:
    ...
    **Example output**
    ...
    opentelemetry-collector   otel   deployment   0.146.0   1/1     9m35s   build-harbor.alauda.cn/asm/opentelemetry-collector:0.147.0-r0   managed
    ```
